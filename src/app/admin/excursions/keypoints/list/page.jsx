...
function Page() {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            await axios.get(`http://localhost:5000/api/excursions/keypoints`)
                .then((result) => {
    ...
    const handleDelete = (id) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                try {
                    const response = await axios.delete(`http://localhost:5000/api/excursions/keypoints/${id}`);
                            ...
                            <table className="w-full bg-white rounded-lg shadow-lg overflow-hidden">
                                <thead className="bg-blue-400">
                                    <tr>
                                        ...
                                        <th className="p-2 border border-gray-300 text-white" style={{ width: "40%" }}>Color</th>
                                    ...
                                    {displayedEmployee && displayedEmployee.length > 0 ? (
                                        displayedEmployee.map((element, index) => (
                                            <tr className="hover:bg-gray-100">
                                                ...
                                                <td className="text-center border border-gray-300 text-gray-900 p-1">{element.color}</td>
