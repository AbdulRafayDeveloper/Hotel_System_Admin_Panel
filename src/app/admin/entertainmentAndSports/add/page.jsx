...
function Page() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('http://localhost:5000/api/entertainmentAndSports', formData, {
                headers: {
            ...
            if (response.status == 201) {
                Swal.fire({
                    ...
                    router.push("./../../../../admin/entertainmentAndSports/list");
                });
            } else {
                Swal.fire({
                    icon: "error",
                    ...
                    <div className='p-1'>
                        <div className='mx-auto max-w-[600px] mt-12'>
                            <form onSubmit={handleSubmit} name="employeeForm" id="employeeForm" className="bg-white shadow-md rounded px-12 pb-4 mb-4 py-2 mt-2" method="post">
                                <h1 className='text-2xl font-medium text-center pb-7 text-gray-800 '>Add Entertainment And Sports</h1>
